...
easy_to_predict <- paste0("For each voter in the voter data, is their behavior easy to predict? Respond with one word, ",
                          "yes no. Can only return unknown sparingly, one prediction per voter. in order of the voter id given. Respond (voter id) prediction")
...
gov_services <- paste0("for each voter in the voter data , does the voter think A: small government providing ",
                       ...
                       "Respond with only A B. Can only return unknown sparingly, one prediction per voter. in order of the voter id given. Respond (voter id) prediction")
